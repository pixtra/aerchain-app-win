...
```bash
.venv/bin/pytest -q        # 60 tests: engines, golden dataset, pipeline, aerbot agent, real-OCR extraction, upload ingest + promote, buyer conditions, bulk brief, provider fallback + settings
```
